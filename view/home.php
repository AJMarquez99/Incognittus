...
<section id="product_container">
    ...
    <ul class="carousel">
        <li class="product-container">
            ...
            <div class="product-colors">
                <div class="color lens-red frame-wood-dark"></div>
                <div class="color lens-gray frame-wood"></div>
                <div class="color lens-blue frame-blue"></div>
            </div>
        </li>
        <li class="product-container">
            <div class="product-img img-container">
    ...
    <div class="indicator-container">
        <div class="indicator-single"></div>
        <div class="indicator-single"></div>
        <div class="indicator-single"></div>
        <div class="indicator-single"></div>
        <div class="indicator-single"></div>
...
<section id="us_container">
    ...
    <a class="button green">Learn More</a>
</section>
